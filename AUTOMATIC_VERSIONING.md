...
- **Deterministic builds**: Same content = same tag (e.g., both produce `0.10-a3f5d8e`)
...
DQ_API_TAG:       0.11-b7c2e1f
DQ_ENGINE_TAG:    0.11-c9d6a4b
DQ_PROFILING_TAG: 0.11-d2e8f3c
DQ_FRONTEND_TAG:  0.11-e1f4a6d
DQ_KONG_TAG:      0.11-f5a7b2c

Auxiliary repo images:
DQ_DB_SEED_TAG:     0.11-a1b2c3d
...
export DQ_API_TAG=0.11-custom
export DQ_ENGINE_TAG=0.11-custom
docker-compose up

# Optional: override major.minor base used by scripts/calculate_versions.sh
export MAJOR_MINOR_OVERRIDE=0.11
source <(./scripts/calculate_versions.sh > /dev/null)
```
