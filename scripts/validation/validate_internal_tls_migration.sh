...
require_file "$ROOT_DIR/docker/Dockerfile.ollama-nginx"
require_file "$ROOT_DIR/docker/ollama-nginx.conf"
...
require_present './tmp/certs/services/ollama-nginx:/etc/nginx/certs:ro' "$ROOT_DIR/docker-compose.yml"
require_present './tmp/certs/services/aistor:/root/.minio/certs:ro' "$ROOT_DIR/docker-compose.yml"
require_present './tmp/certs/trust/internal-ca-bundle.pem:/root/.minio/certs/CAs/internal-ca-bundle.pem:ro' "$ROOT_DIR/docker-compose.yml"
...
require_present 'generate_service_cert "ollama-nginx" ollama-nginx localhost 127.0.0.1 ::1' "$ROOT_DIR/scripts/create_certs.sh"
...
require_present 'DQ_LLM_BASE_URL=https://ollama-nginx:8443' "$ROOT_DIR/.env.dev.example"
require_present 'DQ_LLM_BASE_URL=https://ollama-nginx:8443' "$ROOT_DIR/.env.dev.local"
require_present 'DQ_LLM_BASE_URL=https://ollama-nginx:8443' "$ROOT_DIR/.env.test.example"
require_present 'DQ_LLM_BASE_URL=https://ollama-nginx:8443' "$ROOT_DIR/.env.test.local"
require_present 'DQ_LLM_BASE_URL=https://ollama-nginx:8443' "$ROOT_DIR/.env.prod.example"
require_present 'DQ_LLM_BASE_URL=https://ollama-nginx:8443' "$ROOT_DIR/.env.prod.local"
...
require_present 'ssl_verify_client on;' "$ROOT_DIR/docker/ollama-nginx.conf"
require_present 'proxy_pass https://dq-made-easy-llm:8000;' "$ROOT_DIR/docker/ollama-nginx.conf"
require_present 'proxy_ssl_verify on;' "$ROOT_DIR/docker/ollama-nginx.conf"
require_present 'proxy_ssl_trusted_certificate /etc/nginx/certs/mkcert-rootCA.pem;' "$ROOT_DIR/docker/ollama-nginx.conf"
require_present 'proxy_ssl_name dq-made-easy-llm;' "$ROOT_DIR/docker/ollama-nginx.conf"
require_present 'proxy_ssl_server_name on;' "$ROOT_DIR/docker/ollama-nginx.conf"
