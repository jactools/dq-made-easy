...
const sourcePath = resolve(process.cwd(), 'src/components/NotificationCenter.tsx')

describe('NotificationCenter contract', () => {
  it('uses the app-owned button and icon primitives for actions', () => {
    ...
    expect(source).not.toContain("import { Button }")
  })
})