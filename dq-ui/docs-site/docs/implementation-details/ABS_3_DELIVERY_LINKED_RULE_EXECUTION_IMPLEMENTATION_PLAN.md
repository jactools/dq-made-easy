...
Related feature plan: [ABS-3 Delivery-Linked Rule Execution and Result Notes](/docs/features/current/ABS_3_DELIVERY_LINKED_RULE_EXECUTION/)

Current-state references:
- [ABS-3 Delivery-Linked Rule Execution and Result Notes](/docs/features/current/ABS_3_DELIVERY_LINKED_RULE_EXECUTION/)
- [Abstraction features summary](/docs/features/current/ABSTRACTION_FEATURES/)
...
- [ABS-1 Execution Abstraction](/docs/features/current/ABSTRACTION_FEATURES/#abs-1-execution-abstraction-gx--pyspark)
- [ABS-2 Data Catalog Materialization](/docs/features/current/ABS_2_DATA_CATALOG_MATERIALIZATION/)
