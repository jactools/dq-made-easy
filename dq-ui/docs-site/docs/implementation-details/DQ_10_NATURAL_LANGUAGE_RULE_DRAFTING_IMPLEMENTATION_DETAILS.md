...
For the current-state snapshot, see [DQ-10 Natural-Language Rule Drafting Preview](/docs/status/current/DQ-10_NATURAL_LANGUAGE_RULE_DRAFTING_PREVIEW/).
