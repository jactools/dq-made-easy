...
For the phased implementation plan, see [ABS-3 Delivery-Linked Rule Execution - Implementation Plan](/docs/implementation-details/ABS_3_DELIVERY_LINKED_RULE_EXECUTION_IMPLEMENTATION_PLAN/).
...
ABS3-EXE-03 is implemented by [delivery_linked_execution_orchestrator.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/fastapi/app/application/services/delivery_linked_execution_orchestrator.py), the delivery execution endpoint in [data_catalog.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/fastapi/app/api/v1/endpoints/data_catalog.py), and the delivery-linked execution endpoint tests in [test_delivery_linked_execution_endpoints.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/fastapi/tests/api/test_delivery_linked_execution_endpoints.py).
...
2. [x] (ABS3-EXE-02) Resolve applicable GX suites and run plans.
   ...
   Implemented by [delivery_linked_execution_request_resolver.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/fastapi/app/application/services/delivery_linked_execution_request_resolver.py), the delivery execution receipt schema in [data_catalog_view.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/fastapi/app/api/v1/schemas/data_catalog_view.py), and the delivery-linked execution endpoint tests in [test_delivery_linked_execution_endpoints.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/fastapi/tests/api/test_delivery_linked_execution_endpoints.py).
...
6. [x] (ABS3-EXE-06) Add retrieval APIs.
   ...
   Implemented by the delivery-linked execution status endpoint and enriched Data Delivery Note endpoint in [data_catalog.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/fastapi/app/api/v1/endpoints/data_catalog.py), with coverage in [test_delivery_linked_execution_endpoints.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/fastapi/tests/api/test_delivery_linked_execution_endpoints.py) and [test_data_catalog_endpoints.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/fastapi/tests/api/test_data_catalog_endpoints.py).
...
7. [x] (ABS3-EXE-07) Add validation and compatibility tests.
   ...
   Covered by [test_delivery_linked_execution_endpoints.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/fastapi/tests/api/test_delivery_linked_execution_endpoints.py) and [test_data_catalog_endpoints.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/fastapi/tests/api/test_data_catalog_endpoints.py).
...
- [ABS-1 definition](/docs/status/current/ABSTRACTION_FEATURES/)
