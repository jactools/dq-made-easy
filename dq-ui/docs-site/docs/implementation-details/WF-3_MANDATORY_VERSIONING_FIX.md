...
Modified [04_rule_versioning.sql](https://github.com/jactools/dq-rulebuilder/blob/main/dq-db/init/04_rule_versioning.sql) to reference the new filename:
```sql
...
- [WF-3_RULE_VERSIONING_SCHEMA.md](/docs/implementation-details/WF-3_RULE_VERSIONING_SCHEMA/) - Database schema design
- [WF-3_API_ENDPOINTS.md](/docs/implementation-details/WF-3_API_ENDPOINTS/) - API endpoint specifications
- [WF-3_UI_DESIGN.md](/docs/implementation-details/WF-3_UI_DESIGN/) - UI component designs
- [WF-3_DATABASE_MIGRATION_TEST.md](/docs/implementation-details/WF-3_DATABASE_MIGRATION_TEST/) - Initial migration test
- [WF-3_IMPLEMENTATION_COMPLETE.md](/docs/implementation-details/WF-3_IMPLEMENTATION_COMPLETE/) - Overall implementation summary
