...
- [API-5 Business Metadata Integration](/docs/features/current/API_5_METADATA_INTEGRATION/)
...
The formal architecture record for this terminology lives under [architecture/adr](https://github.com/jactools/dq-rulebuilder/blob/main/architecture/adr) and is indexed from [architecture/ARCHITECTURAL_DECISIONS.md](/docs/architecture/ARCHITECTURAL_DECISIONS/).
