...
1. A versioned runtime-neutral contract package at [docs/contracts/validation-artifact-envelope/v1/schema.json](https://github.com/jactools/dq-rulebuilder/blob/main/docs/contracts/validation-artifact-envelope/v1/schema.json).
...
- Contract package: [docs/contracts/validation-artifact-envelope/README.md](/docs/contracts/validation-artifact-envelope/)
- JSON Schema: [docs/contracts/validation-artifact-envelope/v1/schema.json](https://github.com/jactools/dq-rulebuilder/blob/main/docs/contracts/validation-artifact-envelope/v1/schema.json)
- Examples: [docs/contracts/validation-artifact-envelope/v1/example.json](https://github.com/jactools/dq-rulebuilder/blob/main/docs/contracts/validation-artifact-envelope/v1/example.json) and [docs/contracts/validation-artifact-envelope/v1/example.yaml](https://github.com/jactools/dq-rulebuilder/blob/main/docs/contracts/validation-artifact-envelope/v1/example.yaml)
...
1. A versioned request contract package at [docs/contracts/self-built-pyspark-executor-request/v1/schema.json](https://github.com/jactools/dq-rulebuilder/blob/main/docs/contracts/self-built-pyspark-executor-request/v1/schema.json).
...
1. A versioned contract package now exists at [docs/contracts/pyspark-native-artifact-envelope/v1/schema.json](https://github.com/jactools/dq-rulebuilder/blob/main/docs/contracts/pyspark-native-artifact-envelope/v1/schema.json).
...
5. Compiler-to-artifact mapping rules now live in [ABS_1_PYSPARK_NATIVE_COMPILER_MAPPING.md](/docs/implementation-details/ABS_1_PYSPARK_NATIVE_COMPILER_MAPPING/).
...
1. [x] (ABS1-GX-01) Define canonical abstraction contract.
   ...
   Implemented by the canonical GX artifact envelope in [docs/contracts/gx-artifact-envelope/v1/schema.json](https://github.com/jactools/dq-rulebuilder/blob/main/docs/contracts/gx-artifact-envelope/v1/schema.json), [docs/contracts/gx-artifact-envelope/v1/example.json](https://github.com/jactools/dq-rulebuilder/blob/main/docs/contracts/gx-artifact-envelope/v1/example.json), and [docs/contracts/gx-artifact-envelope/v1/example.yaml](https://github.com/jactools/dq-rulebuilder/blob/main/docs/contracts/gx-artifact-envelope/v1/example.yaml), plus the phase-A contract and registry baseline in [DQ_7_4_GX_SUITE_ORCHESTRATION_IMPLEMENTATION_DETAILS.md](/docs/implementation-details/DQ_7_4_GX_SUITE_ORCHESTRATION_IMPLEMENTATION_DETAILS/).
...
2. [x] (ABS1-GX-02) Implement GX suite registry.
   ...
   Implemented by the `gx_suite_registry`, `gx_suite_execution_target_map`, `gx_suite_rule_map`, and `gx_suite_status_history` tables, together with the Phase A write, status, and retrieval APIs in [DQ_7_4_GX_SUITE_ORCHESTRATION_IMPLEMENTATION_DETAILS.md](/docs/implementation-details/DQ_7_4_GX_SUITE_ORCHESTRATION_IMPLEMENTATION_DETAILS/).
...
3. [x] (ABS1-GX-03) Add suite retrieval APIs.
   ...
   Implemented by the Phase A retrieval API contract in [DQ_7_4_GX_SUITE_ORCHESTRATION_IMPLEMENTATION_DETAILS.md](/docs/implementation-details/DQ_7_4_GX_SUITE_ORCHESTRATION_IMPLEMENTATION_DETAILS/), including `GET /rulebuilder/v1/gx/suites`, `GET /rulebuilder/v1/gx/suites/&#123;suiteId&#125;`, and the scope validation rules for `dataObjectId`, `dataObjectVersionId`, `datasetId`, and `dataProductId`.
...
5. [x] (ABS1-GX-05) Add pluggable data source adapters.
   ...
   Implemented by the data source strategy and adapter contract in [DQ_7_4_GX_SUITE_ORCHESTRATION_IMPLEMENTATION_DETAILS.md](/docs/implementation-details/DQ_7_4_GX_SUITE_ORCHESTRATION_IMPLEMENTATION_DETAILS/), which defines Spark DataFrames, JDBC-backed sources, file-based readers, and the adapter methods `resolve_asset(scope)`, `load_dataframe(asset_ref)`, `materialize_primary_key(df, primary_key_config)`, and `emit_validation_target(df, gx_context)`.
...
6. [x] (ABS1-GX-06) Separate result persistence.
   ...
   Implemented by API-7 Phase 4 persistence in [API_7_REAL_DQ_RULE_EXECUTION_MILESTONE.md](/docs/implementation-details/API_7_REAL_DQ_RULE_EXECUTION_MILESTONE/) and [API_7_REAL_DQ_RULE_EXECUTION.md](/docs/status/current/API_7_REAL_DQ_RULE_EXECUTION/), which store run metadata in the rule/result store and row-level violations in a separate exception store scoped to `dataObjectVersionId`.
...
7. [x] (ABS1-GX-07) Enforce minimal exception record schema.
   ...
   Implemented: the exception-store boundary in [DQ_7_4_GX_SUITE_ORCHESTRATION_IMPLEMENTATION_DETAILS.md](/docs/implementation-details/DQ_7_4_GX_SUITE_ORCHESTRATION_IMPLEMENTATION_DETAILS/) is now enforced in both object storage and the repository-backed DB path. The Alembic head `20260418_0024` has been applied to the live local Postgres database, and the ORM schema plus GX retrieval integration slice now validate that contract successfully.
...
8. [x] (ABS1-GX-08) Add observability and validation tests.
   ...
   Completed: the API-7 observability phase in [API_7_REAL_DQ_RULE_EXECUTION_MILESTONE.md](/docs/implementation-details/API_7_REAL_DQ_RULE_EXECUTION_MILESTONE/), the GX logging and monitoring checklist in [docs/technical/LOGGING_AND_MONITORING_POLICY_IMPLEMENTATION_CHECKLIST.md](/docs/technical/LOGGING_AND_MONITORING_POLICY_IMPLEMENTATION_CHECKLIST/), and the GX worker / API monitoring panels and alerts now have validation coverage across compile, retrieval, execution, and persistence.

   ABS1-GX-08c completion evidence:
   - Structured log-field contract passes via [scripts/validate_logging_required_fields_contract.sh](https://github.com/jactools/dq-rulebuilder/blob/main/scripts/validate_logging_required_fields_contract.sh).
   - Correlation propagation contract passes via [scripts/validate_correlation_propagation.sh](https://github.com/jactools/dq-rulebuilder/blob/main/scripts/validate_correlation_propagation.sh).
   - Compile-path test slice passes via [dq-api/fastapi/tests/application/services/test_rule_compiler.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/fastapi/tests/application/services/test_rule_compiler.py) and [dq-api/fastapi/tests/unit/test_rules_helpers_more.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/fastapi/tests/unit/test_rules_helpers_more.py).
   - Retrieval-path integration slice passes via [dq-api/fastapi/tests/infrastructure/integration/test_gx_retrieval_integration.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/fastapi/tests/infrastructure/integration/test_gx_retrieval_integration.py).
   - Monitoring baseline passes via [scripts/validate_monitoring_baseline.sh](https://github.com/jactools/dq-rulebuilder/blob/main/scripts/validate_monitoring_baseline.sh), with dashboard and alert assets anchored in [observability/grafana/provisioning/dashboards/dq-api-observability.json](https://github.com/jactools/dq-rulebuilder/blob/main/observability/grafana/provisioning/dashboards/dq-api-observability.json) and [observability/prometheus/alerts.yml](https://github.com/jactools/dq-rulebuilder/blob/main/observability/prometheus/alerts.yml).

   ABS1-GX-08d completion evidence:
   - Execution API slice passes via [dq-api/fastapi/tests/api/test_execution_monitoring.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/fastapi/tests/api/test_execution_monitoring.py), covering run retrieval, status history, failure reporting, and fail-fast worker availability.
   - Delivery-linked failure persistence slice passes via [dq-api/fastapi/tests/api/test_delivery_linked_execution_endpoints.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/fastapi/tests/api/test_delivery_linked_execution_endpoints.py), confirming run summaries and row-level violations remain separated.
   - Exception storage slice passes via [dq-api/fastapi/tests/application/services/test_exception_storage.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/fastapi/tests/application/services/test_exception_storage.py).
   - Worker execution and correlation slice passes via [dq-engine/tests/test_gx_dispatch_worker.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-engine/tests/test_gx_dispatch_worker.py) and [dq-engine/tests/test_correlation_runtime_chain.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-engine/tests/test_correlation_runtime_chain.py).
   - Monitoring baseline passes via [scripts/validate_monitoring_baseline.sh](https://github.com/jactools/dq-rulebuilder/blob/main/scripts/validate_monitoring_baseline.sh), with runtime dashboard and alert assets anchored in [observability/grafana/provisioning/dashboards/dq-execution-monitoring.json](https://github.com/jactools/dq-rulebuilder/blob/main/observability/grafana/provisioning/dashboards/dq-execution-monitoring.json) and [observability/prometheus/alerts.yml](https://github.com/jactools/dq-rulebuilder/blob/main/observability/prometheus/alerts.yml).
...
- [ABS-1 definition](/docs/features/ABS_1_EXECUTION_ABSTRACTION/)
- [DQ_7_4 GX suite orchestration](/docs/implementation-details/DQ_7_4_GX_SUITE_ORCHESTRATION_IMPLEMENTATION_DETAILS/)
- [ABS-3 implementation details](/docs/implementation-details/ABS_3_DELIVERY_LINKED_RULE_EXECUTION_IMPLEMENTATION_DETAILS/)