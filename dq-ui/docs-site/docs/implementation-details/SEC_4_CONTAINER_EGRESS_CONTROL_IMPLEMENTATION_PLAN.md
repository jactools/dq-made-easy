...
- [ADR-032 Container Egress Deny-by-Default and Approved-Destination Enforcement](/docs/architecture/adr/ADR-032-container-egress-deny-by-default-and-approved-destination-enforcement/)
- [EDR-044 Container Egress Enforcement and Environment-Specific Claims](/docs/engineering-decisions/EDR-044-INF-container-egress-enforcement-and-environment-specific-claims/)
