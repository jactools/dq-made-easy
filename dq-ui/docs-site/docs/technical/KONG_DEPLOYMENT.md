...
- **[KONG_GATEWAY_SETUP.md](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/KONG_GATEWAY_SETUP.md)** - Complete setup guide with architecture, Docker Compose, plugins, JWT setup
- **[KONG_QUICKSTART.md](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/KONG_QUICKSTART.md)** - Quick start and testing guide
- **[ARCHITECTURAL_DECISIONS.md](/docs/architecture/ARCHITECTURAL_DECISIONS/)** - ADR-009 explaining Kong selection over APIM
- **[API_GATEWAY_DESIGN.md](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/API_GATEWAY_DESIGN.md)** - Gateway responsibilities and design
- **[V1_MIGRATION_BIG_BANG.md](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/V1_MIGRATION_BIG_BANG.md)** - Endpoint migration guide
