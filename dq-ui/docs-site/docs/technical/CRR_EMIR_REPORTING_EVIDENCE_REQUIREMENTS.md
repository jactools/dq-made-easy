...
**Related ADRs**: [ADR-030](/docs/architecture/adr/ADR-030-eu-financial-regulatory-baseline-and-control-mapping/), [ADR-018](/docs/architecture/adr/ADR-018-iso-11179-based-data-definition-framework-for-bcbs-239-and-mifid-ii/)  
**Related baseline**: [DQ-REG-EU-FIN-001](/docs/technical/EU_FINANCIAL_REGULATORY_CONTROL_MAPPING/)
...
- Governed definitions SHOULD reference the semantic model established by [ADR-018](/docs/architecture/adr/ADR-018-iso-11179-based-data-definition-framework-for-bcbs-239-and-mifid-ii/) and [ISO_11179_DATA_DEFINITION_FRAMEWORK.md](/docs/technical/ISO_11179_DATA_DEFINITION_FRAMEWORK/).
