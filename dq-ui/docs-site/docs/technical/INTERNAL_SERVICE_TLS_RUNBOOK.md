...
For the broader SEC-5 no-HTTP policy and the current exception boundary, see [SEC-5 No-HTTP Contract and Exception Boundary](/docs/implementation-details/SEC_5_NO_HTTP_CONTRACT_AND_EXCEPTION_BOUNDARY/).
