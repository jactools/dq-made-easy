...
**Baseline**: [DQ-REG-EU-FIN-001](/docs/technical/EU_FINANCIAL_REGULATORY_CONTROL_MAPPING/)  
**Version**: 1.0  
**Date**: 2026-04-22  
...
Provide a current-state repository gap analysis against the EU financial regulatory control baseline captured in [EU_FINANCIAL_REGULATORY_CONTROL_MAPPING.md](/docs/technical/EU_FINANCIAL_REGULATORY_CONTROL_MAPPING/).
...
| --- | --- | --- | --- | --- |
| `EU-GAP-001` | BCBS 239, GDPR, CRR, MiFID II, EMIR, DORA | Data protection and data access policy | high | tracked by [ARCH-EXC-0006](/docs/architecture/deviations/ARCH-EXC-0006-repository-wide-data-protection-and-data-access-policy-is-not-yet-defined/) |
...
| `EU-GAP-004` | DORA, GDPR | Secure internal transport not fully enforced | high | tracked by [ARCH-EXC-0001](/docs/architecture/deviations/ARCH-EXC-0001-internal-service-transport-still-defaults-to-plaintext-links/) |
| `EU-GAP-005` | DORA, GDPR | Observability RBAC documented but not runtime-enforced | high | tracked by [ARCH-EXC-0005](/docs/architecture/deviations/ARCH-EXC-0005-c3-observability-rbac-is-documented-but-not-yet-enforced/) |
| `EU-GAP-006` | CRR, EMIR, BCBS 239 | Regulated reporting evidence and control attestation | medium | baseline defined by [DQ-REG-CRR-EMIR-001](/docs/technical/CRR_EMIR_REPORTING_EVIDENCE_REQUIREMENTS/); feature-specific evidence bundles still pending |
...
- [EDR-023-API-auth-scope-enforcement-and-role-based-access.md](/docs/engineering-decisions/EDR-023-API-auth-scope-enforcement-and-role-based-access/)
...
- Explicitly tracked by [ARCH-EXC-0006](/docs/architecture/deviations/ARCH-EXC-0006-repository-wide-data-protection-and-data-access-policy-is-not-yet-defined/).
...
- [dq-api/fastapi/app/infrastructure/security/entity_field_encryptor.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/fastapi/app/infrastructure/security/entity_field_encryptor.py)
- [dq-api/fastapi/tests/infrastructure/unit/repositories/postgres/test_app_config_repository_postgres.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/fastapi/tests/infrastructure/unit/repositories/postgres/test_app_config_repository_postgres.py)
- [EU_FINANCIAL_REGULATORY_CONTROL_MAPPING.md](/docs/technical/EU_FINANCIAL_REGULATORY_CONTROL_MAPPING/)
...
- Security feature baseline now tracked in [SEC-5 Sensitive Data Encryption-at-Rest and Key Segregation](/docs/features/SEC_5_SENSITIVE_DATA_ENCRYPTION_AND_KEY_SEGREGATION/).
...
- [SEC_1_INTERNAL_SERVICE_TLS.md](/docs/features/SEC_1_INTERNAL_SERVICE_TLS/)
...
- Explicitly tracked by [ARCH-EXC-0001](/docs/architecture/deviations/ARCH-EXC-0001-internal-service-transport-still-defaults-to-plaintext-links/).
...
- Explicitly tracked by [ARCH-EXC-0005](/docs/architecture/deviations/ARCH-EXC-0005-c3-observability-rbac-is-documented-but-not-yet-enforced/).
...
- Partially addressed through [CRR_EMIR_REPORTING_EVIDENCE_REQUIREMENTS.md](/docs/technical/CRR_EMIR_REPORTING_EVIDENCE_REQUIREMENTS/).
