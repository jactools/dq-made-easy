...
Related policy: [Data Protection and Access Policy](/docs/technical/DATA_PROTECTION_AND_ACCESS_POLICY/)
Related ADR: [ADR-030 EU Financial Regulatory Baseline and Control Mapping](/docs/architecture/adr/ADR-030-eu-financial-regulatory-baseline-and-control-mapping/)
Related control map: [EU Financial Regulatory Control Mapping](/docs/technical/EU_FINANCIAL_REGULATORY_CONTROL_MAPPING/)
Related gap analysis: [EU Financial Regulatory Gap Analysis](/docs/technical/gap-analysis/EU_FINANCIAL_REGULATORY_GAP_ANALYSIS/)
Related deviation: [ARCH-EXC-0006: Repository-Wide Data Protection and Data Access Policy Is Not Yet Defined](/docs/architecture/deviations/ARCH-EXC-0006-repository-wide-data-protection-and-data-access-policy-is-not-yet-defined/)
Related security baseline: [SEC-5 Sensitive Data Encryption-at-Rest and Key Segregation](/docs/features/SEC_5_SENSITIVE_DATA_ENCRYPTION_AND_KEY_SEGREGATION/)
