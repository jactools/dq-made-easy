...
**Workstream:** WS9-A04  
**Spec:** [docs/features/ONBOARDING_FEATURES.md](/docs/features/ONBOARDING_FEATURES/)  
**User Guide:** [docs/user-manuals/workflow-onboarding-rule-generation.md](/docs/user-manuals/workflow-onboarding-rule-generation/)  
