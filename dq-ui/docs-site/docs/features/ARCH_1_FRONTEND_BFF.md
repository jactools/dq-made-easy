...
- [SEC_1_INTERNAL_SERVICE_TLS.md](/docs/features/SEC_1_INTERNAL_SERVICE_TLS/) — internal service TLS model
- [SEC_5_SENSITIVE_DATA_ENCRYPTION_AND_KEY_SEGREGATION.md](/docs/features/SEC_5_SENSITIVE_DATA_ENCRYPTION_AND_KEY_SEGREGATION/) — TLS enforcement
- [ARCH_1_FRONTEND_BFF.md](/docs/features/ARCH_1_FRONTEND_BFF/) — this document
