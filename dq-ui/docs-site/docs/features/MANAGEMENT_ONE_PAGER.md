...
- **All platform capabilities**: [FEATURES.md](/docs/features/) — authoritative feature reference
- **Implementation status** (Done vs Planned): [README.md](/docs/features/) — status tracking and split feature files
- **Management summary** of what's shipped: [MANAGEMENT_FEATURE_SUMMARY.md](https://github.com/jactools/dq-rulebuilder/blob/main/MANAGEMENT_FEATURE_SUMMARY.md)
- **Planned & future work**: [MANAGEMENT_FUTURE_WORK_SUMMARY.md](https://github.com/jactools/dq-rulebuilder/blob/main/MANAGEMENT_FUTURE_WORK_SUMMARY.md)
- **Workstream roadmap & sequencing**: [FEATURE_ROADMAP_OVERVIEW.md](/docs/features/FEATURE_ROADMAP_OVERVIEW/)
