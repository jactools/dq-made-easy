...
Completed work is tracked separately in [../MANAGEMENT_FEATURE_SUMMARY.md](https://github.com/jactools/dq-rulebuilder/blob/main/MANAGEMENT_FEATURE_SUMMARY.md) and in the current-state documents under [../README.md](/docs/).
...
- Detailed feature docs under [../../features/README.md](https://github.com/jactools/dq-rulebuilder/blob/main/features/README.md) hold deeper backlog, acceptance criteria, and sequencing notes.
...
- [x] `WS9-A02` Expand workflow coverage for operators, data stewards, analysts, admins, and developers.
	- Status: Role-based workflow guides published in `docs/user-manuals/`: [workflow-operator.md](/docs/user-manuals/workflow-operator/), [workflow-data-steward.md](/docs/user-manuals/workflow-data-steward/), [workflow-analyst.md](/docs/user-manuals/workflow-analyst/), [workflow-admin.md](/docs/user-manuals/workflow-admin/), [workflow-developer.md](/docs/user-manuals/workflow-developer/). Index updated with a role-based entry section.
- [x] `WS9-A03` Decide whether to keep or migrate the current docs publishing model.
	- Status: Decision formalised in [EDR-046-META-docs-publishing-model-keep-docusaurus-baked-into-ui.md](/docs/engineering-decisions/EDR-046-META-docs-publishing-model-keep-docusaurus-baked-into-ui/). Current Docusaurus model retained; independent docs build step identified as a follow-on improvement.
- [x] `WS9-A04` Add guided generation of standard rules for selected data objects.
	- Status: ONB-1 feature specified in [`docs/features/ONBOARDING_FEATURES.md`](/docs/features/ONBOARDING_FEATURES/) with scope selection model, metadata-driven proposal algorithm, progressive-disclosure review tree, bulk select/de-select UX, and batch draft creation flow. User workflow guide published in [`docs/user-manuals/workflow-onboarding-rule-generation.md`](/docs/user-manuals/workflow-onboarding-rule-generation/).
...
- [API_5_METADATA_INTEGRATION.md](/docs/features/API_5_METADATA_INTEGRATION/)
- [API_7_REAL_DQ_RULE_EXECUTION.md](/docs/features/API_7_REAL_DQ_RULE_EXECUTION/)
- [RULE_STATUS_TRANSITIONS.md](/docs/features/RULE_STATUS_TRANSITIONS/)
- [EXECUTION_MONITORING_METRIC_TAXONOMY.md](/docs/technical/EXECUTION_MONITORING_METRIC_TAXONOMY/)
- [MANAGEMENT_FEATURE_SUMMARY.md](https://github.com/jactools/dq-rulebuilder/blob/main/MANAGEMENT_FEATURE_SUMMARY.md)
- [Frontend UI portability](/docs/features/FRONTEND_UI_PORTABILITY_FEATURES/)

The implementation principle is simple: extend the existing platform seams, do not create a second platform beside them.

## Quick Links

- [Feature doc index](https://github.com/jactools/dq-rulebuilder/blob/main/features/README.md)
- [Data Quality features](/docs/features/DQ_FEATURES/)
- [Integration and API features](/docs/features/API_FEATURES/)
- [Frontend UI portability](/docs/features/FRONTEND_UI_PORTABILITY_FEATURES/)
- [Workflow enhancements](/docs/features/WORKFLOW_FEATURES/)
- [WF-5 dedicated environment contract](/docs/features/WF_5_DEDICATED_ENVIRONMENT_CONTRACT/)
- [Security features](/docs/features/SEC_FEATURES/)
- [Analytics and reporting](/docs/features/ANALYTICS_REPORTING_FEATURES/)
- [Documentation improvements](/docs/features/DOCUMENTATION_FEATURES/)
- [Onboarding](/docs/features/ONBOARDING_FEATURES/)
- [Agentic AI ecosystem capabilities](/docs/features/AGENTIC_AI_ECOSYSTEM_FEATURES/)
- [Current-state summary](https://github.com/jactools/dq-rulebuilder/blob/main/MANAGEMENT_FEATURE_SUMMARY.md)
- [Management future work summary](https://github.com/jactools/dq-rulebuilder/blob/main/MANAGEMENT_FUTURE_WORK_SUMMARY.md)
