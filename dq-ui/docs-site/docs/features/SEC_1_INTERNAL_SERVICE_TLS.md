...
Related architecture: [ADR-027 Internal Service Communication Uses Repository-Managed TLS](/docs/architecture/adr/ADR-027-internal-service-communication-uses-repository-managed-tls/)

Implementation plan: [SEC-1 Internal Service TLS Implementation Plan](/docs/implementation-details/SEC_1_INTERNAL_SERVICE_TLS_IMPLEMENTATION_PLAN/)
