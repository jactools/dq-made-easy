...
Milestone doc: [API-7 Real DQ Rule Execution Milestone](/docs/implementation-details/API_7_REAL_DQ_RULE_EXECUTION_MILESTONE/)
...
- Shared Prometheus metric families and labels for that dashboard are defined in [EXECUTION_MONITORING_METRIC_TAXONOMY.md](/docs/technical/EXECUTION_MONITORING_METRIC_TAXONOMY/).
