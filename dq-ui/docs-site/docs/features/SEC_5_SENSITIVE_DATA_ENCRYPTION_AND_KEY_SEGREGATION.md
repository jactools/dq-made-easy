...
Related regulatory gaps: [EU Financial Regulatory Gap Analysis](/docs/technical/gap-analysis/EU_FINANCIAL_REGULATORY_GAP_ANALYSIS/)

Current implementation evidence: [entity_field_encryptor.py](https://github.com/jactools/dq-rulebuilder/blob/main/dq-api/fastapi/app/infrastructure/security/entity_field_encryptor.py)
