...
Tracked Work Items
- [x] `DQ-5.1` Define repository-backed domain entities and contracts for suggestions, interactions, profiling requests, and source metadata ([detail](/docs/features/current/DQ-5_ADVANCED_DATA_PROFILING/))
...
Status note: DQ-10 is complete. The current-state snapshot now lives in [docs/features/current/DQ-10_NATURAL_LANGUAGE_RULE_DRAFTING_PREVIEW.md](/docs/features/current/DQ-10_NATURAL_LANGUAGE_RULE_DRAFTING_PREVIEW/).
...
Roadmap alignment: `DQ-19.9` is tracked in `WS-10` as the Agentic AI Ecosystem workstream in [docs/features/roadmap/FEATURE_ROADMAP_OVERVIEW.md](/docs/features/roadmap/FEATURE_ROADMAP_OVERVIEW/).
