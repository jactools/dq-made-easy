...
Tracked Work Items
- [x] `DQ-5.1` Define repository-backed domain entities and contracts for suggestions, interactions, profiling requests, and source metadata ([detail](/docs/features/DQ-5_ADVANCED_DATA_PROFILING/))
...
Status note: DQ-10 is complete. The current-state snapshot now lives in [docs/features/DQ-10_NATURAL_LANGUAGE_RULE_DRAFTING_PREVIEW.md](/docs/features/DQ-10_NATURAL_LANGUAGE_RULE_DRAFTING_PREVIEW/).
