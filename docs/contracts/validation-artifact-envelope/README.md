...
- Execution outcomes are not part of this input-artifact contract. See the [dq-results](../dq-results/README.md) contract for rule outcomes, threshold comparisons, and record counts.
