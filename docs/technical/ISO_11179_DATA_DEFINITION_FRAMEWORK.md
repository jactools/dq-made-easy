...
**Related ADR**: [ADR-018](../../architecture/adr/ADR-018-iso-11179-based-data-definition-framework-for-bcbs-239-and-mifid-ii.md)
...
- [ISO 11179 + OpenMetadata implementation details](../implementation-details/ISO_11179_OPENMETADATA_IMPLEMENTATION_DETAILS.md)
- [ISO 11179 + Open Data Product Specification implementation details](../implementation-details/ISO_11179_OPEN_DATA_PRODUCT_SPECIFICATION_IMPLEMENTATION_DETAILS.md)
- [ABS-2 Data Catalog Materialization and Data Delivery Notes](../features/current/ABS_2_DATA_CATALOG_MATERIALIZATION.md)
- [ABS-3 Delivery-Linked Rule Execution and Result Notes](../features/current/ABS_3_DELIVERY_LINKED_RULE_EXECUTION.md)
- [ADR-014](../../architecture/adr/ADR-014-gx-suite-registry-pyspark-execution-and-exception-store-separation.md)
- [ADR-017](../../architecture/adr/ADR-017-canonical-snake_case-api-fields.md)
