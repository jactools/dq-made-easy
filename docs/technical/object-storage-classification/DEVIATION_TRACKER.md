...
| SEC3-F-AC-02: synthetic results treated as synthetic in documentation | ✅ Partial | Operator guidance created; test materialization labels set; CSV staging lacks labels (DEV-002) |
