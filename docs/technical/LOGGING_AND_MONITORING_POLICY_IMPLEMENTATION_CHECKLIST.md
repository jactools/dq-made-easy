...
Related policy: [LOGGING_AND_MONITORING_POLICY_ISO27001.md](./LOGGING_AND_MONITORING_POLICY_ISO27001.md)
Related ADR: [ADR-016](../../architecture/adr/ADR-016-iso27001-logging-and-monitoring-policy-adoption.md)
...
- [x] Verify JSON logging is enabled at startup:
  - [dq-api/fastapi/app/main.py](../../dq-api/fastapi/app/main.py)
  - [dq-api/fastapi/app/core/logging_config.py](../../dq-api/fastapi/app/core/logging_config.py)
- [x] Ensure all critical flows emit structured events:
  - [dq-api/fastapi/app/api/v1/endpoints/gx.py](../../dq-api/fastapi/app/api/v1/endpoints/gx.py)
  - [dq-api/fastapi/app/api/v1/endpoints/rules.py](../../dq-api/fastapi/app/api/v1/endpoints/rules.py)
...
Validation evidence:
- [x] Redaction tests and governance contract: [dq-api/fastapi/tests/core/test_log_event_redaction.py](../../dq-api/fastapi/tests/core/test_log_event_redaction.py), [scripts/validate_log_redaction_contract.sh](../../scripts/validate_log_redaction_contract.sh)

### Engine and Worker Services

- [x] Add/verify JSON structured logging in:
  - [dq-engine](../../dq-engine)
  - [dq-profiling](../../dq-profiling)
- [x] Ensure rule execution and exception write paths include event + correlation fields.

Validation evidence:
- [x] Engine/worker structured logging governance gate: [scripts/validate_engine_worker_logging.sh](../../scripts/validate_engine_worker_logging.sh)
- [x] Engine JSON logging utilities and execution/failure events: [dq-utils/src/dq_utils/logging_utils.py](../../dq-utils/src/dq_utils/logging_utils.py), [dq-engine/main.py](../../dq-engine/main.py)
- [x] Worker JSON logging utility and correlation-aware job/failure events: [dq-profiling/src/logger.ts](../../dq-profiling/src/logger.ts), [dq-profiling/src/worker.ts](../../dq-profiling/src/worker.ts)
...
Validation evidence:
- [x] Required-fields contract validator: [scripts/validate_logging_required_fields_contract.sh](../../scripts/validate_logging_required_fields_contract.sh)

## 2. Correlation and Traceability (Annex A 8.15 / 8.16)

- [x] Verify correlation ID generation + propagation middleware:
  - [dq-api/fastapi/app/middleware/correlation_id.py](../../dq-api/fastapi/app/middleware/correlation_id.py)
  - [dq-api/fastapi/app/core/request_context.py](../../dq-api/fastapi/app/core/request_context.py)
...
Validation evidence:
- [x] Middleware/request-context verification tests: [dq-api/fastapi/tests/middleware/test_middleware_focus.py](../../dq-api/fastapi/tests/middleware/test_middleware_focus.py), [dq-api/fastapi/tests/core/test_request_context.py](../../dq-api/fastapi/tests/core/test_request_context.py)
- [x] Correlation propagation contract gate passes: [scripts/validate_correlation_propagation.sh](../../scripts/validate_correlation_propagation.sh)
- [x] Engine correlation helper unit tests: [dq-engine/tests/test_correlation.py](../../dq-engine/tests/test_correlation.py)
- [x] Runtime chain fixture validates single CID across API header -> engine forwarding -> worker payload normalization: [dq-engine/tests/test_correlation_runtime_chain.py](../../dq-engine/tests/test_correlation_runtime_chain.py)
- [x] Stubbed end-to-end HTTP smoke validates CID continuity across ingress -> engine -> API hops -> worker payload: [scripts/verify_correlation_chain_smoke.sh](../../scripts/verify_correlation_chain_smoke.sh)
...
Validation evidence:
- [x] Baseline validator script passes: [scripts/validate_monitoring_baseline.sh](../../scripts/validate_monitoring_baseline.sh)
- [x] Alert coverage includes auth failure and exception-store write failure: [observability/prometheus/alerts.yml](../../observability/prometheus/alerts.yml)

### Dashboards

- [x] Define the shared execution-monitoring metric taxonomy and label rules:
  - [docs/technical/EXECUTION_MONITORING_METRIC_TAXONOMY.md](../../docs/technical/EXECUTION_MONITORING_METRIC_TAXONOMY.md)
...
Dashboard evidence:
- [x] Grafana dashboard definition (auto-provisioned): [observability/grafana/provisioning/dashboards/dq-execution-monitoring.json](../../observability/grafana/provisioning/dashboards/dq-execution-monitoring.json)
...
- [x] Dedicated ISO 27001 logging and monitoring dashboard: [observability/grafana/provisioning/dashboards/dq-iso27001-logging-monitoring.json](../../observability/grafana/provisioning/dashboards/dq-iso27001-logging-monitoring.json)
...
- [x] Shared metric contract: [docs/technical/EXECUTION_MONITORING_METRIC_TAXONOMY.md](../../docs/technical/EXECUTION_MONITORING_METRIC_TAXONOMY.md)
...
Runbook evidence:
- [x] Incident runbooks and index: [docs/runbooks/README.md](../../docs/runbooks/README.md)
- [x] API 5xx spike runbook: [docs/runbooks/INCIDENT_API_5XX_SPIKE.md](../../docs/runbooks/INCIDENT_API_5XX_SPIKE.md)
- [x] Compile failure spike runbook: [docs/runbooks/INCIDENT_COMPILE_FAILURE_SPIKE.md](../../docs/runbooks/INCIDENT_COMPILE_FAILURE_SPIKE.md)
- [x] Executor timeout spike runbook: [docs/runbooks/INCIDENT_EXECUTOR_TIMEOUT_SPIKE.md](../../docs/runbooks/INCIDENT_EXECUTOR_TIMEOUT_SPIKE.md)
- [x] Exception store write failure runbook: [docs/runbooks/INCIDENT_EXCEPTION_STORE_WRITE_FAILURE.md](../../docs/runbooks/INCIDENT_EXCEPTION_STORE_WRITE_FAILURE.md)

## 4. Time Synchronization (Annex A 8.17)

- [x] Confirm all services run with UTC timezone configuration in compose/runtime:
  - db, api, dq-engine, profiling-worker all configured with TZ: UTC in [docker-compose.yml](../../docker-compose.yml)
- [x] Confirm log formatter timestamps are UTC:
  - [dq-api/fastapi/app/core/logging_config.py](../../dq-api/fastapi/app/core/logging_config.py) uses `time.gmtime()` for UTC
  - [dq-utils/src/dq_utils/logging_utils.py](../../dq-utils/src/dq_utils/logging_utils.py) emits UTC timestamps
- [x] Add CI check or startup self-check that rejects non-UTC runtime configuration for critical services:
  - CI governance gate: [scripts/validate_time_synchronization_utc.sh](../../scripts/validate_time_synchronization_utc.sh)
  - Integrated into [.github/workflows/governance-gates.yml](../../.github/workflows/governance-gates.yml)
...
- [x] Complete access control policy: [docs/technical/LOG_INTEGRITY_AND_ACCESS_CONTROL.md](../../docs/technical/LOG_INTEGRITY_AND_ACCESS_CONTROL.md)
...
- [x] Complete retention and disposal policy: [docs/technical/LOG_RETENTION_AND_DISPOSAL_POLICY.md](../../docs/technical/LOG_RETENTION_AND_DISPOSAL_POLICY.md)
...
- [x] Capture alert definitions and trigger test evidence:
  - Prometheus alert rules from [observability/prometheus/alerts.yml](../../observability/prometheus/alerts.yml)
...
- [x] Capture dashboard screenshots or exported JSON:
  - Grafana dashboard JSON: [observability/grafana/dashboards/dq-execution-monitoring.json](../../observability/grafana/dashboards/dq-execution-monitoring.json)
...
- [x] Capture retention configuration evidence:
  ...
  - Configuration sources: [docker-compose.yml](../../docker-compose.yml), loki-config.yml, tempo-config.yml
...
- [x] Complete evidence pack artifact: [docs/technical/EVIDENCE_PACK_ISO27001_LOGGING_MONITORING.md](../../docs/technical/EVIDENCE_PACK_ISO27001_LOGGING_MONITORING.md)
...
Governance evidence:
- [x] CI governance workflow enforces monitoring + correlation gates: [.github/workflows/governance-gates.yml](../../.github/workflows/governance-gates.yml)
- [x] Static critical-endpoint logging instrumentation gate: [scripts/validate_logging_instrumentation.sh](../../scripts/validate_logging_instrumentation.sh)
- [x] Release governance docs gate and release checklist policy item: [scripts/validate_release_governance_docs.sh](../../scripts/validate_release_governance_docs.sh), [docs/releases/RELEASE_READINESS_CHECKLIST.md](../../docs/releases/RELEASE_READINESS_CHECKLIST.md)
- [x] Quarterly governance reminder workflow (owner: @jacbeekers): [.github/workflows/quarterly-governance-reminder.yml](../../.github/workflows/quarterly-governance-reminder.yml)

## 9. Ownership Matrix

- [x] API team: endpoint instrumentation + correlation tests
  - Implementation: [dq-api/fastapi/app/core/log_event.py](../../dq-api/fastapi/app/core/log_event.py) with redaction
  - Testing: [dq-api/fastapi/tests/core/test_log_event_redaction.py](../../dq-api/fastapi/tests/core/test_log_event_redaction.py)
  - Correlation: [dq-api/fastapi/tests/middleware/test_middleware_focus.py](../../dq-api/fastapi/tests/middleware/test_middleware_focus.py)
- [x] Engine team: execution/exception telemetry coverage
  - Implementation: [dq-engine/main.py](../../dq-engine/main.py) with structured events
  - Logger utility: [dq-utils/src/dq_utils/logging_utils.py](../../dq-utils/src/dq_utils/logging_utils.py)
  - Testing: [dq-engine/tests/test_correlation.py](../../dq-engine/tests/test_correlation.py), [test_correlation_runtime_chain.py](../../dq-engine/tests/test_correlation_runtime_chain.py)
- [x] Platform/SRE: observability stack operation, retention, alert routing
  ...
  - Governance gates: [.github/workflows/governance-gates.yml](../../.github/workflows/governance-gates.yml)
...
- [x] Complete ownership matrix: [docs/technical/OWNERSHIP_MATRIX.md](../../docs/technical/OWNERSHIP_MATRIX.md)
...
- [x] required alerts are active and tested
  - ✅ Four critical alerts in [observability/prometheus/alerts.yml](../../observability/prometheus/alerts.yml)
  - ✅ Alert testing completed (March 15, 2026): all fire within 5-minute window
  - ✅ Runbooks available: [docs/runbooks/](../../docs/runbooks/)
- [x] dashboards exist for compile/retrieval/execution/exception-store paths
  - ✅ Grafana dashboard: [observability/grafana/provisioning/dashboards/dq-execution-monitoring.json](../../observability/grafana/provisioning/dashboards/dq-execution-monitoring.json) (auto-provisioned)
  - ✅ Panels: compile trend, retrieval latency, error rate, execution throughput, exception volume, write failures
  - ⏳ Note: RBAC enforcement (Viewer/Editor/Admin roles) documented but requires OIDC deployment (see [GRAFANA_RBAC_DEPLOYMENT_GUIDE.md](../../docs/technical/GRAFANA_RBAC_DEPLOYMENT_GUIDE.md))
- [x] retention and access controls are documented and enforced
  - ✅ Retention policy: [docs/technical/LOG_RETENTION_AND_DISPOSAL_POLICY.md](../../docs/technical/LOG_RETENTION_AND_DISPOSAL_POLICY.md)
  - ✅ Access control: [docs/technical/LOG_INTEGRITY_AND_ACCESS_CONTROL.md](../../docs/technical/LOG_INTEGRITY_AND_ACCESS_CONTROL.md)
...
- [x] one full evidence pack is produced and archived
  - ✅ Evidence pack: [docs/technical/EVIDENCE_PACK_ISO27001_LOGGING_MONITORING.md](../../docs/technical/EVIDENCE_PACK_ISO27001_LOGGING_MONITORING.md)
...
- **RBAC Enforcement:** Documented in [LOG_INTEGRITY_AND_ACCESS_CONTROL.md](../../docs/technical/LOG_INTEGRITY_AND_ACCESS_CONTROL.md) and [GRAFANA_RBAC_DEPLOYMENT_GUIDE.md](../../docs/technical/GRAFANA_RBAC_DEPLOYMENT_GUIDE.md)
...
- **Reference:** [GRAFANA_RBAC_DEPLOYMENT_GUIDE.md](../../docs/technical/GRAFANA_RBAC_DEPLOYMENT_GUIDE.md)
...
**Primary Documents:**
1. [LOGGING_AND_MONITORING_POLICY_ISO27001.md](./LOGGING_AND_MONITORING_POLICY_ISO27001.md) — Policy statement
2. [LOGGING_AND_MONITORING_POLICY_IMPLEMENTATION_CHECKLIST.md](./LOGGING_AND_MONITORING_POLICY_IMPLEMENTATION_CHECKLIST.md) — This document
3. [EVIDENCE_PACK_ISO27001_LOGGING_MONITORING.md](./EVIDENCE_PACK_ISO27001_LOGGING_MONITORING.md) — Audit evidence
...
- [OWNERSHIP_MATRIX.md](./OWNERSHIP_MATRIX.md) — Team responsibilities
- [ADR-016](../../architecture/adr/ADR-016-iso27001-logging-and-monitoring-policy-adoption.md) — Architecture decision

**Operational Artifacts:**
- [.github/workflows/governance-gates.yml](../../.github/workflows/governance-gates.yml) — Automated enforcement
- [.github/workflows/quarterly-governance-reminder.yml](../../.github/workflows/quarterly-governance-reminder.yml) — Compliance tracking
- [docs/runbooks/](../../docs/runbooks/) — Incident response procedures
- [observability/grafana/dashboards/](../../observability/grafana/dashboards/) — Grafana dashboards
- [observability/prometheus/alerts.yml](../../observability/prometheus/alerts.yml) — Alert definitions
