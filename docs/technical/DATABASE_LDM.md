...
For full entity and element definitions, including BDE/CDE classification, see [DATABASE_LDM_DEFINITIONS.md](./DATABASE_LDM_DEFINITIONS.md).
...
- Non-UI public APIs use business keys from [BUSINESS_KEYS.md](../features/BUSINESS_KEYS.md).
...
- When a logical entity gets a new public lookup path, update [BUSINESS_KEYS.md](../features/BUSINESS_KEYS.md) at the same time.
...
- The detailed entity and element registry lives in [DATABASE_LDM_DEFINITIONS.md](./DATABASE_LDM_DEFINITIONS.md).
