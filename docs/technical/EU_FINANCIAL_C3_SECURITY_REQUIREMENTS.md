...
- Cryptographic choices for `C=3` deployments MUST follow approved repository baselines, including [ADR-027](../../architecture/adr/ADR-027-internal-service-communication-uses-repository-managed-tls.md) and [ADR-028](../../architecture/adr/ADR-028-post-quantum-cryptography-must-be-implemented-by-2026-12-31.md).
...
- The logging and monitoring baseline in [LOGGING_AND_MONITORING_POLICY_ISO27001.md](./LOGGING_AND_MONITORING_POLICY_ISO27001.md) MUST apply.
...
- be recorded in [ARCHITECTURE_DEVIATIONS_AND_EXCEPTIONS.md](../../architecture/ARCHITECTURE_DEVIATIONS_AND_EXCEPTIONS.md),
...
- [ADR-016 ISO 27001-Aligned Logging and Monitoring Policy Adoption](../../architecture/adr/ADR-016-iso27001-logging-and-monitoring-policy-adoption.md)
...
- [ADR-028 Post-Quantum Cryptography Must Be Implemented by 2026-12-31](../../architecture/adr/ADR-028-post-quantum-cryptography-must-be-implemented-by-2026-12-31.md)
- [ADR-029 EU Financial C=3 Security Baseline Mandate](../../architecture/adr/ADR-029-eu-financial-c3-security-baseline-mandate.md)
- [EU Financial C=3 Security Implementation Checklist](./EU_FINANCIAL_C3_SECURITY_IMPLEMENTATION_CHECKLIST.md)
- [ARCHITECTURE_DEVIATIONS_AND_EXCEPTIONS.md](../../architecture/ARCHITECTURE_DEVIATIONS_AND_EXCEPTIONS.md)
- [Release Readiness Checklist](../releases/RELEASE_READINESS_CHECKLIST.md)