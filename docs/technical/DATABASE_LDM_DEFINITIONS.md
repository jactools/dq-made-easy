...
This appendix is the detailed definition registry for [DATABASE_LDM.md](./DATABASE_LDM.md).
...
- When a logical element is promoted to a shared contract surface, re-evaluate its class and update this appendix together with [BUSINESS_KEYS.md](../features/BUSINESS_KEYS.md).
