...
For the logical and conceptual layers, see [DATABASE_LDM.md](./DATABASE_LDM.md) and [DATABASE_CDM.md](./DATABASE_CDM.md).
...
Table-level classification is a physical-schema shorthand. Element-level definitions and BDE/CDE labels live in [DATABASE_LDM_DEFINITIONS.md](./DATABASE_LDM_DEFINITIONS.md).
