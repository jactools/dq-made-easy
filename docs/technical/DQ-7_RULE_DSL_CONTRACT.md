...
The authoritative 2.0.0 contract artifacts live in [../contracts/rule-dsl/2.0.0/schema.json](../contracts/rule-dsl/2.0.0/schema.json), [../contracts/rule-dsl/2.0.0/openapi.yaml](../contracts/rule-dsl/2.0.0/openapi.yaml), [../contracts/rule-dsl/2.0.0/example.json](../contracts/rule-dsl/2.0.0/example.json), and [../contracts/rule-dsl/2.0.0/example.yaml](../contracts/rule-dsl/2.0.0/example.yaml).
...
- Contract package: [../contracts/rule-dsl/README.md](../contracts/rule-dsl/README.md)
- Engine-independent implementation plan: [../implementation-details/DQ_7_ENGINE_INDEPENDENT_DSL_IMPLEMENTATION_PLAN.md](../implementation-details/DQ_7_ENGINE_INDEPENDENT_DSL_IMPLEMENTATION_PLAN.md)
- Rule compiler progress: [../implementation-details/DQ_7_3_RULE_COMPILER_IMPLEMENTATION_PROGRESS.md](../implementation-details/DQ_7_3_RULE_COMPILER_IMPLEMENTATION_PROGRESS.md)
- GX capability guidance: [../user-manuals/gx-capability-guidance.md](../user-manuals/gx-capability-guidance.md)