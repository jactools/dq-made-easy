...
Related requirement: [EU_FINANCIAL_C3_SECURITY_REQUIREMENTS.md](./EU_FINANCIAL_C3_SECURITY_REQUIREMENTS.md)
Related ADR: [ADR-029](../../architecture/adr/ADR-029-eu-financial-c3-security-baseline-mandate.md)
...
- [x] Establish the governing requirement and ADR for `C=3` handling.
  ...
  - [ADR-029](../../architecture/adr/ADR-029-eu-financial-c3-security-baseline-mandate.md)
...
Evidence:
- [x] Release checklist includes the requirement ID: [RELEASE_READINESS_CHECKLIST.md](../releases/RELEASE_READINESS_CHECKLIST.md)
...
- [ ] [ARCH-EXC-0004](../../architecture/deviations/ARCH-EXC-0004-c3-deployments-still-allow-permissive-local-auth-and-default-credentials.md)
...
- [ ] [ARCH-EXC-0002](../../architecture/deviations/ARCH-EXC-0002-adr-028-post-quantum-baseline-is-not-yet-implemented.md)
- [ ] [ARCH-EXC-0003](../../architecture/deviations/ARCH-EXC-0003-vendor-managed-oidc-and-jwks-surfaces-lack-repository-validated-pq-hybrid-path.md)
...
- [x] Include `DQ-SEC-EU-C3-001` in release readiness.
  - [RELEASE_READINESS_CHECKLIST.md](../releases/RELEASE_READINESS_CHECKLIST.md)
