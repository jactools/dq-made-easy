...
description: "Human-readable test proof generated from test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260704T233127Z.json."
---
...
This page was generated from [test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260704T233127Z.json](../../../../test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260704T233127Z.json).
...
| --- | --- |
| App Version | 0.11.5 |
| Proof Id | kafka-violations-pipeline-20260704T233127Z |
| Proof Type | engine |
| Feature | kafka-violations-pipeline |
| Status | passed |
| Executed At Utc | 2026-07-04T23:31:27.033772+00:00 |
| Test File Count | 3 |
| Test Count | 8 |
| Command | bash scripts/validation/validate_kafka_violations_pipeline.sh |
| Raw Evidence Directory | test-results/evidence/0.11.5/api/kafka-violations-pipeline-20260704T233127Z |
...
- DQ run triggered successfully (run_id=run-48f256e7ae4f)
...
- Pipeline executed end-to-end in 75340ms
...
```json
{
  ...
  "rule_id": "rule-e8a5f77ea06841d49191b4f2802c61a3",
  "rule_name": "Kafka violations smoke 9257dd73f259",
  "run_id": "run-48f256e7ae4f",
  "run_status": "failed",
