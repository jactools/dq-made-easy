...
description: "Human-readable test proof generated from test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T120940Z.json."
---
...
This page was generated from [test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T120940Z.json](../../../../test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T120940Z.json).
...
| --- | --- |
| App Version | 0.11.5 |
| Proof Id | kafka-violations-pipeline-20260705T120940Z |
| Proof Type | engine |
| Feature | kafka-violations-pipeline |
| Status | passed |
| Executed At Utc | 2026-07-05T12:09:40.189279+00:00 |
| Test File Count | 2 |
| Test Count | 8 |
| Command | bash scripts/validation/validate_kafka_violations_pipeline.sh |
| Raw Evidence Directory | test-results/evidence/0.11.5/api/kafka-violations-pipeline-20260705T120940Z |
...
- DQ run triggered successfully (run_id=run-64ef57a70a8a)
...
- Pipeline executed end-to-end in 67048ms
...
```json
{
  ...
  "rule_id": "rule-a21d674d17ac49488c8157feb96c356b",
  "rule_name": "Kafka violations smoke 5d123d31035a",
  "run_id": "run-64ef57a70a8a",
  "run_status": "failed",
