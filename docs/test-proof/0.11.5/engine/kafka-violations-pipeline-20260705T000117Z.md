...
description: "Human-readable test proof generated from test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T000117Z.json."
---
...
This page was generated from [test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T000117Z.json](../../../../test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T000117Z.json).
...
| --- | --- |
| App Version | 0.11.5 |
| Proof Id | kafka-violations-pipeline-20260705T000117Z |
| Proof Type | engine |
| Feature | kafka-violations-pipeline |
| Status | passed |
| Executed At Utc | 2026-07-05T00:01:17.079056+00:00 |
| Test File Count | 3 |
| Test Count | 8 |
| Command | bash scripts/validation/validate_kafka_violations_pipeline.sh |
| Raw Evidence Directory | test-results/evidence/0.11.5/api/kafka-violations-pipeline-20260705T000117Z |
...
- DQ run triggered successfully (run_id=run-4d3e66beff9c)
...
- Pipeline executed end-to-end in 66335ms
...
```json
{
  ...
  "rule_id": "rule-803782c7a716499b9e9eebdd45875265",
  "rule_name": "Kafka violations smoke ff8ff638c008",
  "run_id": "run-4d3e66beff9c",
  "run_status": "failed",
