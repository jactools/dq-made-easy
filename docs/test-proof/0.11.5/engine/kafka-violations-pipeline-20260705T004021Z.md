...
description: "Human-readable test proof generated from test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T004021Z.json."
---
...
This page was generated from [test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T004021Z.json](../../../../test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T004021Z.json).
...
| --- | --- |
| App Version | 0.11.5 |
| Proof Id | kafka-violations-pipeline-20260705T004021Z |
| Proof Type | engine |
| Feature | kafka-violations-pipeline |
| Status | passed |
| Executed At Utc | 2026-07-05T00:40:21.552879+00:00 |
| Test File Count | 3 |
| Test Count | 8 |
| Command | bash scripts/validation/validate_kafka_violations_pipeline.sh |
| Raw Evidence Directory | test-results/evidence/0.11.5/api/kafka-violations-pipeline-20260705T004021Z |
...
- DQ run triggered successfully (run_id=run-cbb0fcf07edd)
...
- Pipeline executed end-to-end in 66328ms
...
```json
{
  ...
  "rule_id": "rule-e0aa17a2f0fa423282579d78161430f9",
  "rule_name": "Kafka violations smoke 1da87f86a023",
  "run_id": "run-cbb0fcf07edd",
  "run_status": "failed",
