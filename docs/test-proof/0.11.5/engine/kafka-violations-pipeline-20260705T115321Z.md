...
description: "Human-readable test proof generated from test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T115321Z.json."
---
...
This page was generated from [test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T115321Z.json](../../../../test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T115321Z.json).
...
| --- | --- |
| App Version | 0.11.5 |
| Proof Id | kafka-violations-pipeline-20260705T115321Z |
| Proof Type | engine |
| Feature | kafka-violations-pipeline |
| Status | passed |
| Executed At Utc | 2026-07-05T11:53:21.925099+00:00 |
| Test File Count | 2 |
| Test Count | 8 |
| Command | bash scripts/validation/validate_kafka_violations_pipeline.sh |
| Raw Evidence Directory | test-results/evidence/0.11.5/api/kafka-violations-pipeline-20260705T115321Z |
...
- DQ run triggered successfully (run_id=run-24a3916fb136)
...
- Pipeline executed end-to-end in 66470ms
...
```json
{
  ...
  "rule_id": "rule-96951d214d5b489d937907ccb6dacd30",
  "rule_name": "Kafka violations smoke 44ec6cbf94f8",
  "run_id": "run-24a3916fb136",
  "run_status": "failed",
