...
description: "Human-readable test proof generated from test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T000558Z.json."
---
...
This page was generated from [test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T000558Z.json](../../../../test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T000558Z.json).
...
| --- | --- |
| App Version | 0.11.5 |
| Proof Id | kafka-violations-pipeline-20260705T000558Z |
| Proof Type | engine |
| Feature | kafka-violations-pipeline |
| Status | passed |
| Executed At Utc | 2026-07-05T00:05:58.640861+00:00 |
| Test File Count | 3 |
| Test Count | 8 |
| Command | bash scripts/validation/validate_kafka_violations_pipeline.sh |
| Raw Evidence Directory | test-results/evidence/0.11.5/api/kafka-violations-pipeline-20260705T000558Z |
...
- DQ run triggered successfully (run_id=run-f00c5232bcf0)
...
- Pipeline executed end-to-end in 66437ms
...
```json
{
  ...
  "rule_id": "rule-24b2309137f144a9a23888cca5802e3d",
  "rule_name": "Kafka violations smoke c121fe68e350",
  "run_id": "run-f00c5232bcf0",
  "run_status": "failed",
