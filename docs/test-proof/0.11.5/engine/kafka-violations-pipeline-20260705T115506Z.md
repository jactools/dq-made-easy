...
description: "Human-readable test proof generated from test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T115506Z.json."
---
...
This page was generated from [test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T115506Z.json](../../../../test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T115506Z.json).
...
| --- | --- |
| App Version | 0.11.5 |
| Proof Id | kafka-violations-pipeline-20260705T115506Z |
| Proof Type | engine |
| Feature | kafka-violations-pipeline |
| Status | passed |
| Executed At Utc | 2026-07-05T11:55:06.772819+00:00 |
| Test File Count | 2 |
| Test Count | 8 |
| Command | bash scripts/validation/validate_kafka_violations_pipeline.sh |
| Raw Evidence Directory | test-results/evidence/0.11.5/api/kafka-violations-pipeline-20260705T115506Z |
...
- DQ run triggered successfully (run_id=run-6db8f4f10f86)
...
- Pipeline executed end-to-end in 64379ms
...
```json
{
  ...
  "rule_id": "rule-d540b96d5bff4bf48d3b72e5636e1008",
  "rule_name": "Kafka violations smoke ea7f2d4dd6be",
  "run_id": "run-6db8f4f10f86",
  "run_status": "failed",
