...
description: "Human-readable test proof generated from test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260704T234725Z.json."
---
...
This page was generated from [test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260704T234725Z.json](../../../../test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260704T234725Z.json).
...
| --- | --- |
| App Version | 0.11.5 |
| Proof Id | kafka-violations-pipeline-20260704T234725Z |
| Proof Type | engine |
| Feature | kafka-violations-pipeline |
| Status | passed |
| Executed At Utc | 2026-07-04T23:47:25.771022+00:00 |
| Test File Count | 3 |
| Test Count | 8 |
| Command | bash scripts/validation/validate_kafka_violations_pipeline.sh |
| Raw Evidence Directory | test-results/evidence/0.11.5/api/kafka-violations-pipeline-20260704T234725Z |
...
- DQ run triggered successfully (run_id=run-4c14a7a5d9e9)
...
- Pipeline executed end-to-end in 66149ms
...
```json
{
  ...
  "rule_id": "rule-08a2740e298843469a3fca872b4faf6b",
  "rule_name": "Kafka violations smoke 390b4e3b717e",
  "run_id": "run-4c14a7a5d9e9",
  "run_status": "failed",
