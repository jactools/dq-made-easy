...
description: "Human-readable test proof generated from test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T002718Z.json."
---
...
This page was generated from [test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T002718Z.json](../../../../test-results/test-proof/0.11.5/engine/kafka-violations-pipeline-20260705T002718Z.json).
...
| --- | --- |
| App Version | 0.11.5 |
| Proof Id | kafka-violations-pipeline-20260705T002718Z |
| Proof Type | engine |
| Feature | kafka-violations-pipeline |
| Status | passed |
| Executed At Utc | 2026-07-05T00:27:18.225628+00:00 |
| Test File Count | 3 |
| Test Count | 8 |
| Command | bash scripts/validation/validate_kafka_violations_pipeline.sh |
| Raw Evidence Directory | test-results/evidence/0.11.5/api/kafka-violations-pipeline-20260705T002718Z |
...
- DQ run triggered successfully (run_id=run-b404602e0c07)
...
- Pipeline executed end-to-end in 66363ms
...
```json
{
  ...
  "rule_id": "rule-b38fa75d7e434c5ea27bf229072ecb19",
  "rule_name": "Kafka violations smoke b887a564a994",
  "run_id": "run-b404602e0c07",
  "run_status": "failed",
