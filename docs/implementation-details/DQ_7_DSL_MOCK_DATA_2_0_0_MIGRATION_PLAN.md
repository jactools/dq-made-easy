...
Related contract: [DQ-7 Rule DSL Contract](../technical/DQ-7_RULE_DSL_CONTRACT.md)
Current-state references:
- [DQ-7 Executable Rule Transformation](../features/current/DQ-7_EXECUTABLE_RULE_TRANSFORMATION.md)
Related rollout policy: [DQ-7 DSL Rollout Policy](DQ_7_DSL_ROLLOUT_POLICY.md)
Related implementation plan: [DQ-7 Engine-Independent DSL Implementation Plan](DQ_7_ENGINE_INDEPENDENT_DSL_IMPLEMENTATION_PLAN.md)
...
2. [x] `DQ7-SEED-002` Define the canonical `2.0.0` seed templates for each semantic family.
   - [x] Template catalog scaffolded in [../contracts/rule-dsl/2.0.0/seed-templates/catalog.json](../contracts/rule-dsl/2.0.0/seed-templates/catalog.json).
...
3. [x] `DQ7-SEED-003` Rewrite GX-native mock-data seeds to canonical `2.0.0`.
   - [x] Canonical GX-native subset generated in [../../validation-data/validate_rule_lifecycle_gx_native_cases_2_0_0.json](../../validation-data/validate_rule_lifecycle_gx_native_cases_2_0_0.json).
...
4. [x] `DQ7-SEED-004` Rewrite GX-partial seeds to canonical `2.0.0` with explicit fidelity labels.
   - [x] Canonical GX-partial subset generated in [../../validation-data/validate_rule_lifecycle_gx_partial_cases_2_0_0.json](../../validation-data/validate_rule_lifecycle_gx_partial_cases_2_0_0.json).
...
5. [x] `DQ7-SEED-005` Convert expression-only seed cases into explicit semantic contract shapes.
   - [x] Canonical expression-only subset generated in [../../validation-data/validate_rule_lifecycle_gx_expression_only_cases_2_0_0.json](../../validation-data/validate_rule_lifecycle_gx_expression_only_cases_2_0_0.json).
...
6. [x] `DQ7-SEED-006` Rebuild validation fixtures from the canonical `2.0.0` seeds.
   - [x] Regenerate `validation-data` cases from the rewritten seed set in [../../validation-data/validate_rule_lifecycle_gx_rebuilt_cases_2_0_0.json](../../validation-data/validate_rule_lifecycle_gx_rebuilt_cases_2_0_0.json).
   ...
   - [x] Normalize the suite names in [../../dq-db/mock-data/gx-suite-registry.csv](../../dq-db/mock-data/gx-suite-registry.csv) and [../../dq-db/mock-data/validation-artifact-registry.csv](../../dq-db/mock-data/validation-artifact-registry.csv) to the canonical versionless suite identifiers.
...
7. [x] `DQ7-SEED-007` Add fail-fast tests for the supported and unsupported GX paths.
   ...
   - [x] Added regression coverage in [../../dq-api/fastapi/tests/application/use_cases/test_rule_mutation_use_cases.py](../../dq-api/fastapi/tests/application/use_cases/test_rule_mutation_use_cases.py) for a canonical supported case and an explicit unsupported GX lowering path.
