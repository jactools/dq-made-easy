...
- [x] SMP-01 Define the service dependency manifest
  ...
  - Manifest: [STACK_SERVICE_DEPENDENCY_MANIFEST.md](STACK_SERVICE_DEPENDENCY_MANIFEST.md)
...
- [x] SMP-02 Extract shared shell primitives
  ...
  - Plan: [STACK_SHARED_SHELL_PRIMITIVES_PLAN.md](STACK_SHARED_SHELL_PRIMITIVES_PLAN.md)
...
- [x] SMP-06 Add a shared auth helper
  ...
  - Helper: [scripts/supporting/auth.sh](scripts/supporting/auth.sh)
...
- [x] SMP-07 Add readiness and health helpers
  ...
  - Helper: [scripts/supporting/readiness.sh](../../scripts/supporting/readiness.sh)
...
- [x] SMP-08 Add dependency planning
  ...
  - Helper: [scripts/supporting/dependency_planning.sh](../../scripts/supporting/dependency_planning.sh)
...
- [x] SMP-09 Separate reconciliation from startup
  ...
  - Entry point: [scripts/reconcile_stack.sh](../../scripts/reconcile_stack.sh)
...
- [x] SMP-11 Keep smoke validation separate
  ...
  - Entry point: [scripts/smoke_stack.sh](../../scripts/smoke_stack.sh)
...
- [x] SMP-12 Document the script contract
  ...
  - Doc: [STACK_SCRIPT_CONTRACT.md](STACK_SCRIPT_CONTRACT.md)
...
- [x] SMP-13 Consolidate lifecycle into single-responsibility scripts with orchestrator
  ...
  - Scripts: [scripts/stack.sh](../../scripts/stack.sh), [scripts/stack_destroy.sh](../../scripts/stack_destroy.sh), [scripts/stack_start.sh](../../scripts/stack_start.sh), [scripts/stack_stop.sh](../../scripts/stack_stop.sh), [scripts/stack_restart.sh](../../scripts/stack_restart.sh), [scripts/stack_seed.sh](../../scripts/stack_seed.sh), [scripts/supporting/stack_lifecycle.sh](../../scripts/supporting/stack_lifecycle.sh)
