...
PUBLIC mode still uses path-based HTTP routing with TLS termination at the edge. This is documented as **Phase 2** work in [SEC_5_W6_IMPLEMENTATION_STRATEGY.md](./SEC_5_W6_IMPLEMENTATION_STRATEGY.md). Options:
