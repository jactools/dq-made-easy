...
**Related Guides:**
- [OBSERVABILITY_SETUP.md](./OBSERVABILITY_SETUP.md) — Detailed architecture & design
- [OPENTELEMETRY_IMPLEMENTATION.md](./OPENTELEMETRY_IMPLEMENTATION.md) — In-depth instrumentation patterns
