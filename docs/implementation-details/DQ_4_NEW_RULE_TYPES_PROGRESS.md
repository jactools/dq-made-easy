...
> Use [DQ-7 Rule DSL Contract](../technical/DQ-7_RULE_DSL_CONTRACT.md) and [DQ-7 Engine-Independent DSL Implementation Plan](DQ_7_ENGINE_INDEPENDENT_DSL_IMPLEMENTATION_PLAN.md) for current guidance.
...
Full context and acceptance criteria: [DQ_FEATURES.md — DQ-4 section](../features/DQ_FEATURES.md#dq-4-new-rule-types--checks)
