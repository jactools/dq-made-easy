...
Related feature note: [../features/DQ-7_RULE_DSL_CONTRACT.md](../features/DQ-7_RULE_DSL_CONTRACT.md)
...
22. [x] `DQ7-DSL-022` Add rollout controls and compatibility gates.
    ...
    .4 [x] Keep rollout policy separate from the 021 guidance docs and UI discovery cards. Documented in [DQ_7_DSL_ROLLOUT_POLICY.md](./DQ_7_DSL_ROLLOUT_POLICY.md) and exposed only through the admin app-config surface.
