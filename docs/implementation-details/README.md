...
- [DQ_20_EXECUTION_DISPATCH_AND_LOWERER_MODULE_SPLIT_PLAN.md](./DQ_20_EXECUTION_DISPATCH_AND_LOWERER_MODULE_SPLIT_PLAN.md) — Actionable split plan for making `execution_dispatch` the shared abstraction layer and keeping GX/lowerer modules separate
...
- [WF_7_AZURE_CONTAINER_APPS_ENVIRONMENT_DEPLOYMENT_IMPLEMENTATION_PLAN.md](./WF_7_AZURE_CONTAINER_APPS_ENVIRONMENT_DEPLOYMENT_IMPLEMENTATION_PLAN.md)
