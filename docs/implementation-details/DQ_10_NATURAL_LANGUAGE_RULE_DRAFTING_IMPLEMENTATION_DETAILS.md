...
For the current-state snapshot, see [DQ-10 Natural-Language Rule Drafting Preview](../features/DQ-10_NATURAL_LANGUAGE_RULE_DRAFTING_PREVIEW.md).
...
- [DQ-10 current-state snapshot](../features/DQ-10_NATURAL_LANGUAGE_RULE_DRAFTING_PREVIEW.md)
