...
Related feature plan: [API-7 Real DQ Rule Execution](../features/current/API_7_REAL_DQ_RULE_EXECUTION.md)
...
This is the short list of known gaps required for end-to-end, meaningful real execution. Detailed GX-suite orchestration backlog lives in [DQ-7.4 Great Expectations Suite Orchestration - Implementation Details](./DQ_7_4_GX_SUITE_ORCHESTRATION_IMPLEMENTATION_DETAILS.md).
...
- Delivery-level reruns and latest-vs-pinned delivery selection are tracked in [API_7_DATA_DELIVERY_RESOLUTION.md](./API_7_DATA_DELIVERY_RESOLUTION.md).
