...
Architectural decision: [ARCH_1_FRONTEND_BFF.md](../features/ARCH_1_FRONTEND_BFF.md)
...
Map to the acceptance criteria in [ARCH_1_FRONTEND_BFF.md](../features/ARCH_1_FRONTEND_BFF.md):
