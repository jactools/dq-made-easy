...
- DQ-10 natural-language rule drafting preview has moved to the implemented/current-state docs at [docs/status/current/DQ-10_NATURAL_LANGUAGE_RULE_DRAFTING_PREVIEW.md](../current/DQ-10_NATURAL_LANGUAGE_RULE_DRAFTING_PREVIEW.md) and is no longer future work.
