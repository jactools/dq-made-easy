...
- [ABS_1_EXECUTION_ABSTRACTION.md](./ABS_1_EXECUTION_ABSTRACTION.md) — execution abstraction foundation
- [DQ_19_MULTI_RUNTIME_LOWERERS.md](./DQ_19_MULTI_RUNTIME_LOWERERS.md) — multi-runtime lowerers (complementary)
- [DQ-7 Executable Rule Transformation](./DQ-7_EXECUTABLE_RULE_TRANSFORMATION.md) — rule execution foundation
