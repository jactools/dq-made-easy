...
- [ABS-3 definition](../features/current/ABS_3_DELIVERY_LINKED_RULE_EXECUTION.md)
...
- The runtime-neutral contract now lives in [docs/contracts/validation-artifact-envelope/v1/schema.json](../contracts/validation-artifact-envelope/v1/schema.json) with matching [JSON example](../contracts/validation-artifact-envelope/v1/example.json) and [YAML example](../contracts/validation-artifact-envelope/v1/example.yaml).
...
- The draft self-built PySpark executor request contract now lives in [docs/contracts/self-built-pyspark-executor-request/v1/schema.json](../contracts/self-built-pyspark-executor-request/v1/schema.json) with matching [JSON example](../contracts/self-built-pyspark-executor-request/v1/example.json) and [YAML example](../contracts/self-built-pyspark-executor-request/v1/example.yaml).
...
- A PySpark-native engine contract now lives in [docs/contracts/pyspark-native-artifact-envelope/v1/schema.json](../contracts/pyspark-native-artifact-envelope/v1/schema.json) with matching [JSON example](../contracts/pyspark-native-artifact-envelope/v1/example.json) and [YAML example](../contracts/pyspark-native-artifact-envelope/v1/example.yaml).
...
- The self-built PySpark executor request contract now also includes a second example request carrying a `pyspark_native` item at [docs/contracts/self-built-pyspark-executor-request/v1/example_pyspark_native.json](../contracts/self-built-pyspark-executor-request/v1/example_pyspark_native.json) and [YAML rendering](../contracts/self-built-pyspark-executor-request/v1/example_pyspark_native.yaml).
- Compiler-to-artifact mapping rules for the new engine now live in [ABS-1 PySpark-native compiler mapping](../implementation-details/ABS_1_PYSPARK_NATIVE_COMPILER_MAPPING.md).
...
- [ADR-011: Executable Rule Transformation Strategy](../../architecture/adr/ADR-011-executable-rule-transformation-strategy-dsl-first-with-great-expectations-adapter.md)
