...
Related work: [SEC-1 Internal Service-to-Service TLS](./SEC_1_INTERNAL_SERVICE_TLS.md)
Related architecture: [ADR-028 Post-Quantum Cryptography Must Be Implemented by 2026-12-31](../../architecture/adr/ADR-028-post-quantum-cryptography-must-be-implemented-by-2026-12-31.md)
Implementation plan: [SEC-2: Post-Quantum Cryptography Implementation Plan](../implementation-details/SEC_2_POST_QUANTUM_IMPLEMENTATION_PLAN.md)
Deviation register: [Architecture Deviations and Exceptions Register](../../architecture/ARCHITECTURE_DEVIATIONS_AND_EXCEPTIONS.md)
