...
Related architecture: [ADR-032 Container Egress Deny-by-Default and Approved-Destination Enforcement](../../architecture/adr/ADR-032-container-egress-deny-by-default-and-approved-destination-enforcement.md)
...
Implementation plan: [SEC-4 Container Egress Control Implementation Plan](../implementation-details/SEC_4_CONTAINER_EGRESS_CONTROL_IMPLEMENTATION_PLAN.md)
