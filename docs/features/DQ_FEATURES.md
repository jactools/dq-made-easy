...
- [x] #DQ-3c Data Assets
- Planning doc: [DATA_ASSETS_FEATURES.md](./DATA_ASSETS_FEATURES.md)
- Implementation details: [DQ_3C_DATA_ASSETS_IMPLEMENTATION_DETAILS.md](../implementation-details/DQ_3C_DATA_ASSETS_IMPLEMENTATION_DETAILS.md)
...
- Standard-feature rollout plan: [DQ_1_RULE_VALIDATION_STANDARD_FEATURE_IMPLEMENTATION_PLAN.md](../implementation-details/DQ_1_RULE_VALIDATION_STANDARD_FEATURE_IMPLEMENTATION_PLAN.md)
...
- [x] `DQ-4.1` Define `RuleCheckType` taxonomy: domain entities, backend schema, frontend types, and DB columns ([implementation progress](../implementation-details/DQ_4_NEW_RULE_TYPES_PROGRESS.md))
...
Tracked Work Items
- [x] `DQ-5.1` Define repository-backed domain entities and contracts for suggestions, interactions, profiling requests, and source metadata ([detail](../features/current/DQ-5_ADVANCED_DATA_PROFILING.md))
...
- [x] `DQ-7.DT-01` DSL vs Great Expectations architecture decision record ([ADR-011](../../architecture/adr/ADR-011-executable-rule-transformation-strategy-dsl-first-with-great-expectations-adapter.md))
- [x] `DQ-7.DT-02` Expression syntax guidance and supported-grammar coverage ([DQ-1 Rule Validation User Guide](../user-manuals/DQ-1_RULE_VALIDATION_USER_GUIDE.md), [DQ-2 Join Conditions User Guide](../user-manuals/DQ-2_JOIN_CONDITIONS_USER_GUIDE.md))
- [x] `DQ-7.DT-03` Rule compiler to intermediate executable model ([implementation progress](../implementation-details/DQ_7_3_RULE_COMPILER_IMPLEMENTATION_PROGRESS.md))
- [x] `DQ-7.DT-04` Great Expectations adapter (if GE/hybrid path selected) ([implementation details](../implementation-details/DQ_7_4_GX_SUITE_ORCHESTRATION_IMPLEMENTATION_DETAILS.md), [ADR-014](../../architecture/adr/ADR-014-gx-suite-registry-pyspark-execution-and-exception-store-separation.md))
...
Status note: DQ-10 is complete. The current-state snapshot now lives in [docs/features/current/DQ-10_NATURAL_LANGUAGE_RULE_DRAFTING_PREVIEW.md](../features/current/DQ-10_NATURAL_LANGUAGE_RULE_DRAFTING_PREVIEW.md).
...
See [DQ-12 run plan initiation API and package CLI](../technical/DQ-12_RUN_PLAN_INITIATION_API_AND_CLI.md) for the dedicated external-initiation contract.
...
Implementation plan: [DQ_14_DATA_CONTRACTS_SCHEMA_CHANGE_GOVERNANCE_IMPLEMENTATION_PLAN.md](../implementation-details/DQ_14_DATA_CONTRACTS_SCHEMA_CHANGE_GOVERNANCE_IMPLEMENTATION_PLAN.md)
...
- [x] `DQ-17.4` Add reuse of reconciliation definitions across Data Assets and rules. _(User guide: [DQ_17_RECONCILIATION_WORKFLOW_GUIDE.md](../user-manuals/DQ_17_RECONCILIATION_WORKFLOW_GUIDE.md))_
...
- [x] `DQ-19.6` Data observability triage with issue routing, root-cause drilldown, and remediation actions. _(User guide: [Data Observability Triage Guide](../user-manuals/data-observability-triage-guide.md), v0.11.0)_
