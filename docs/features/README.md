...
Planning docs (all carry `Status: Planned`):
- [FEATURE_ROADMAP_OVERVIEW.md](./FEATURE_ROADMAP_OVERVIEW.md) — canonical single-document roadmap
- [MANAGEMENT_FUTURE_WORK_SUMMARY.md](./MANAGEMENT_FUTURE_WORK_SUMMARY.md) — management-facing summary of remaining work
- [DQ_PLATFORM_GAP_CLOSURE_PLAN.md](./DQ_PLATFORM_GAP_CLOSURE_PLAN.md) — gap closure detail (merged into roadmap overview)
- [REPO_COVERAGE_TEST_PLAN.md](./REPO_COVERAGE_TEST_PLAN.md) — 90 % coverage target plan
...
Quick links:
- [Feature Roadmap Overview](./FEATURE_ROADMAP_OVERVIEW.md)
- [DQ Platform Gap Closure Plan](./DQ_PLATFORM_GAP_CLOSURE_PLAN.md)
...
- Older notes may still mention `planned_features.md`; use [../features/FEATURE_ROADMAP_OVERVIEW.md](../features/FEATURE_ROADMAP_OVERVIEW.md) as the canonical replacement.
...
- [API_1_CONNECTORS.md](./API_1_CONNECTORS.md)
- [DQ_19_MULTI_RUNTIME_LOWERERS.md](./DQ_19_MULTI_RUNTIME_LOWERERS.md)
- [SPARK_EXPECTATIONS_ENGINE_PLAN.md](../implementation-details/SPARK_EXPECTATIONS_ENGINE_PLAN.md)
- [API_2_WEBHOOK_NOTIFICATIONS.md](./API_2_WEBHOOK_NOTIFICATIONS.md)
- [API_3_RATE_LIMITING.md](./API_3_RATE_LIMITING.md)
- [API_4_AUTHENTICATION_OPTIONS.md](./API_4_AUTHENTICATION_OPTIONS.md)
- [API_4_ENTRA_KEYCLOAK_BROKERING.md](./API_4_ENTRA_KEYCLOAK_BROKERING.md)
