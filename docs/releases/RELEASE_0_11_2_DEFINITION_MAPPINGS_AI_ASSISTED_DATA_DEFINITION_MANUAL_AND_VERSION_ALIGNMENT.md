# Release v0.11.2 - Definition Mappings AI-Assisted Data Definition Manual and Version Alignment

**Release date**: 2026-05-27
**UI version**: `0.11.2`
**Docs-site version**: `0.11.2`
**API version**: `0.11.0`

## Summary

This release publishes the AI-assisted Definition Mappings user manual, aligns the repo version markers for the documentation surface, and moves the public docs portal release line to `0.11.2`.

## Included in this release

- UI package metadata is aligned to `0.11.2`
- Docs-site package metadata is aligned to `0.11.2`
...
- Release, deployment, and versioning docs now point at the `v0.11.2` release line
