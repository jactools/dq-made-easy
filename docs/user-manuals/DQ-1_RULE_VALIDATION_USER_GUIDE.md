...
> **Rollout tracking:** [DQ-1 Rule Validation Standard Feature Implementation Plan](../implementation-details/DQ_1_RULE_VALIDATION_STANDARD_FEATURE_IMPLEMENTATION_PLAN.md) — especially `DQ1-I-P2-01`, `DQ1-I-P3-01`, `DQ1-I-P6-01`, and `DQ1-I-AC-01`
...
If your rule depends on relationships across datasets, use the join-definition flow described in the [DQ-2 Join Conditions User Guide](./DQ-2_JOIN_CONDITIONS_USER_GUIDE.md) rather than trying to express cross-dataset joins inside one free-text filter expression.
