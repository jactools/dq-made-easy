...
| Alert | Runbook |
| --- | --- |
| API 5xx spike | [INCIDENT_API_5XX_SPIKE.md](../runbooks/INCIDENT_API_5XX_SPIKE.md) |
| Compile failure spike | [INCIDENT_COMPILE_FAILURE_SPIKE.md](../runbooks/INCIDENT_COMPILE_FAILURE_SPIKE.md) |
| Executor timeout spike | [INCIDENT_EXECUTOR_TIMEOUT_SPIKE.md](../runbooks/INCIDENT_EXECUTOR_TIMEOUT_SPIKE.md) |
| Exception store write failure | [INCIDENT_EXCEPTION_STORE_WRITE_FAILURE.md](../runbooks/INCIDENT_EXCEPTION_STORE_WRITE_FAILURE.md) |
...
- [Stack Script Contract](../implementation-details/STACK_SCRIPT_CONTRACT.md)
- [Incident runbooks](../runbooks/README.md)
- [Documentation ownership policy](../technical/DOCUMENTATION_OWNERSHIP_AND_SOURCE_OF_TRUTH.md)
