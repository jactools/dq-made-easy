...
def test_required_scopes_follow_current_mapping() -> None:
    ...
    assert get_required_scopes("POST", "/system/v1/ui-registry/assets/upload") == ["dq:config:manage"]
    assert get_required_scopes("GET", "/system/v1/ui-registry/assets/styles/theme.css") == []
    assert get_required_scopes("HEAD", "/system/v1/ui-registry/assets/styles/theme.css") == []
