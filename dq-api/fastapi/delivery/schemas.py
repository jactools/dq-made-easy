"""Schema models for Delivery Registry API endpoints.
...
Delivery schemas are self-contained and do not import from the DQ API (app.*).
"""
...
class EmrBaseModel(BaseModel):
    """Base model for Delivery schemas — emits snake_case aliases."""
