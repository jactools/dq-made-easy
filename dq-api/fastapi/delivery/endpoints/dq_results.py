"""Delivery DQ Results endpoints — query DQ results by delivery.

DQ Results are published to Kafka by the DQ engine and consumed by Delivery.
...
from delivery.schemas import EmrDqResultResponseView, EmrDqResultPageView

router = APIRouter(prefix="/dq-results", tags=["delivery-dq-results"])
...
async def query_dq_results(
    ...
    from delivery.domain.dq_result import DeliveryResultPageEntity
