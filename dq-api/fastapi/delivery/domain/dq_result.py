"""DQ Result entity for Delivery — relates DQ execution outcomes to deliveries.
...
class DeliveryResultEntity(BaseModel):
    ...
    consumed by Delivery for canonical tracking.
    """
...
class DeliveryResultPageEntity(BaseModel):
    """Paginated DQ result list."""

    items: list[DeliveryResultEntity] = []
    total: int = 0
    page: int = 1
    limit: int = 100
