"""DQ Results Kafka consumer for Delivery.

Consumes DQ execution results from Kafka and stores them in the Delivery repository,
...
Environment variables:
    ...
    KAFKA_CONSUMER_GROUP_ID — consumer group id (default: delivery-dq-results-group)
    DELIVERY_DQ_RESULTS_ENABLED  — enable DQ results consumer (default: false)
"""
...
from delivery.domain.dq_result import DeliveryResultEntity
...
DEFAULT_CONSUMER_GROUP = "delivery-dq-results-group"
...
class DqResultsConsumer:
    """Consumes DQ results from Kafka and stores them in Delivery.
    ...
    result in the Delivery repository linked to the correct delivery.

    The consumer can be started as a background task in the Delivery app or run
    ...
    def _parse_result(self, payload: dict[str, Any]) -> DeliveryResultEntity | None:
